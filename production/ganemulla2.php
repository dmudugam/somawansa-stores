...
$sql = "UPDATE ganemulla_loading SET units=units+'$cases',value=value+'$value' WHERE date1='$date' AND product='$type'";
...
<html lang="en">
  <head>
    ...
    <title>Ganemulla(RD) - Loading</title>
...
<div class="x_panel">
                  <div class="x_title">
                    <h1 style="color: red;">Ganemulla(RD) - Loading </h1><small> Online Somawansa Stores Warehouse Management System</small></h1>
