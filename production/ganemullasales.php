...
$sql = "SELECT ganemulla_loading.loadingid ,ganemulla_loading.date1, ganemulla_loading.product, ganemulla_loading.units, ganemulla_unloading.ulunits, ganemulla_cdamages.dunits  from ganemulla_loading  LEFT JOIN ganemulla_unloading on ganemulla_loading.date1 = ganemulla_unloading.date1 AND ganemulla_loading.product = ganemulla_unloading.product LEFT JOIN ganemulla_cdamages on ganemulla_unloading.date1=ganemulla_cdamages.date1 AND ganemulla_unloading.product=ganemulla_cdamages.product where ganemulla_loading.date1=cast(now() as date)";
...
<html lang="en">
  <head>
    ...
    <title>Somawansa Stores - Ganemulla(RD) Sales Report</title>
