...
$sql = "SELECT * from ganemulla_cdamages";
...
<html lang="en">
  <head>
    ...
    <title>Somawansa Stores - Ganemulla(RD) Customer Damages</title>
...
<div class="x_panel">
                  <div class="x_title">
                    <h1 style="color: blue;">Ganemulla(RD) - Customer Damage Report </h1> <small>Online Somawansa Stores Warehouse Management System</small>
