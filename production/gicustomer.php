...
$sql = "INSERT INTO gicustomer(date1,product,dunits,value) VALUES ('$date','$type','$cases', '$value')";
...
<html lang="en">
  <head>
    ...
    <title>Ganemulla(INT) - Customer Damages</title>
...
<div class="x_panel">
                  <div class="x_title">
                    <h1 style="color: red;">Ganemulla(Interim) - Customer Damages </h1><small> Online Somawansa Stores Warehouse Management System</small></h1>
