...
$sql = "UPDATE giloading SET units=units+'$cases',value=value+'$value' WHERE date1='$date' AND product='$type'";
...
mysqli_query($dbh2,"UPDATE ganemulla SET date1='$date',units=units-'$cases',value=value-'$value' WHERE product='$type'");
}
?>
...
<html lang="en">
  <head>
    ...
    <title>Ganemulla(INT) - Loading</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="profile.php" class="site_title"><i class="fa fa-paw"></i> <span>Ganemulla(INT)</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <li><a href ="giloading.php"><i class="fa fa-edit"></i> Loading - 1 <span class="fa fa-chevron-down"></span></a>
                  </li>
                  <li><a href ="giloading2.php"><i class="fa fa-edit"></i> Loading - 2<span class="fa fa-chevron-down"></span></a>
                  </li>
                  <li><a href ="giunloading.php"><i class="fa fa-desktop"></i>Unloading<span class="fa fa-chevron-down"></span></a>
                  </li>
                  <li><a href ="gilorry.php"><i class="fa fa-desktop"></i>Lorry Damages<span class="fa fa-chevron-down"></span></a>
                  </li>
                  <li><a href ="gicustomer.php"><i class="fa fa-desktop"></i>Customer Damages<span class="fa fa-chevron-down"></span></a>
                  </li>
...
<div class="x_panel">
                  <div class="x_title">
                    <h1 style="color: red;">Ganemulla(Interim) - Loading 2 </h1><small> Online Somawansa Stores Warehouse Management System</small></h1>
