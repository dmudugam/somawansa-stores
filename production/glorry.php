...
$sql = "INSERT INTO ganemulla_ldamages(date1,product,dunits,value) VALUES ('$date','$type','$cases', '$value')";
...
<html lang="en">
  <head>
    ...
    <title>Ganemulla(RD) - Lorry Damages</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="profile.php" class="site_title"><i class="fa fa-paw"></i> <span>Ganemulla(RD)</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <li><a href ="ganemulla.php"><i class="fa fa-edit"></i> Loading - 1 <span class="fa fa-chevron-down"></span></a>
                  </li>
                  <li><a href ="ganemulla2.php"><i class="fa fa-edit"></i> Loading - 2<span class="fa fa-chevron-down"></span></a>
                  </li>

                  <li><a href ="gunloading.php"><i class="fa fa-desktop"></i>Unloading<span class="fa fa-chevron-down"></span></a>
                  </li>
                  <li><a href ="glorry.php"><i class="fa fa-desktop"></i>Lorry Damages<span class="fa fa-chevron-down"></span></a>
                  </li>
                  <li><a href ="gcustomer.php"><i class="fa fa-desktop"></i>Customer Damages<span class="fa fa-chevron-down"></span></a>
                  </li>
...
<div class="x_panel">
                  <div class="x_title">
                    <h1 style="color: red;">Ganemulla(RD) - Lorry Damages </h1><small> Online Somawansa Stores Warehouse Management System</small></h1>
