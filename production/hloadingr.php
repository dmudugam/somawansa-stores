...
$sql = "SELECT * from horeca_loading where date1 = cast(now() as date)";
...
<html lang="en">
  <head>
    ...
    <title>Somawansa Stores - Horeca Loading Report</title>
...
<div class="x_panel">
                  <div class="x_title">
                    <h1 style="color: blue;">Horeca - Loading Report </h1> <small>Online Somawansa Stores Warehouse Management System</small>
