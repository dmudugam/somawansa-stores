...
$sql = "UPDATE horeca_loading SET units=units+'$cases',value=value+'$value' WHERE date1='$date' AND product='$type'";
...
mysqli_query($dbh2,"UPDATE horeca SET date1='$date',units=units-'$cases',value=value-'$value' WHERE product='$type'");
}
?>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
               ...
               <li><a href ="home.php"><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                ...
                <li><a href ="horeca.php"><i class="fa fa-edit"></i> Loading - 1 <span class="fa fa-chevron-down"></span></a>
                  </li>
                   <li><a href ="horeca2.php"><i class="fa fa-edit"></i> Loading - 2<span class="fa fa-chevron-down"></span></a>
                  </li>

                  <li><a href ="hunloading.php"><i class="fa fa-desktop"></i>Unloading<span class="fa fa-chevron-down"></span></a>
                  </li>
                  <li><a href ="hlorry.php"><i class="fa fa-desktop"></i>Lorry Damages<span class="fa fa-chevron-down"></span></a>
                  </li>
                  <li><a href ="hcustomer.php"><i class="fa fa-desktop"></i>Customer Damages<span class="fa fa-chevron-down"></span></a>
                  </li>
...
<div class="x_panel">
                  <div class="x_title">
                    <h1 style="color: red;">Horeca - Loading 2 </h1><small> Online Somawansa Stores Warehouse Management System</small></h1>
