...
$sql = "SELECT horeca_loading.loadingid ,horeca_loading.date1, horeca_loading.product, horeca_loading.units, horeca_unloading.ulunits, horeca_cdamages.dunits  from horeca_loading  LEFT JOIN horeca_unloading on horeca_loading.date1 = horeca_unloading.date1 AND horeca_loading.product = horeca_unloading.product LEFT JOIN horeca_cdamages on horeca_unloading.date1=horeca_cdamages.date1 AND horeca_unloading.product=horeca_cdamages.product where horeca_loading.date1=cast(now() as date)";
...
<html lang="en">
  <head>
    ...
    <title>Somawansa Stores - Horeca Sales Report</title>
...
<div class="x_panel">
                  <div class="x_title">
                    <h1 style="color: blue;">Horeca Sales Report</h1><small>Online Somawansa Stores Warehouse Management System</small>
