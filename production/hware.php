...
<html lang="en">
  <head>
    ...
    <title>Somawansa Stores - Horeca Warehouse Stock Report</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="profile.php" class="site_title"><i class="fa fa-paw"></i> <span>Horeca</span></a>
            </div>
...
<div class="x_panel">
                  <div class="x_title">
                    <h1 style="color: blue;">Horeca - Warehouse Stock Report </h1> <small>Online Somawansa Stores Warehouse Management System</small>
