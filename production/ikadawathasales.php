...
$sql = "SELECT kiloading.loadingid ,kiloading.date1, kiloading.product, kiloading.units, kiunloading.ulunits, kicustomer.dunits  from kiloading  LEFT JOIN kiunloading on kiloading.date1 = kiunloading.date1 AND kiloading.product = kiunloading.product LEFT JOIN kicustomer on kiunloading.date1=kicustomer.date1 AND kiunloading.product=kicustomer.product where kiloading.date1=cast(now() as date)";
...
<html lang="en">
  <head>
    ...
    <title>Somawansa Stores - Kadawatha(Interim) Sales Report</title>
...
<div class="x_panel">
                  <div class="x_title">
                    <h1 style="color: blue;">Kadawatha(Interim) Sales Report</h1><small>Online Somawansa Stores Warehouse Management System</small>
