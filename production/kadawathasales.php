...
$sql = "SELECT kadawatha_loading.loadingid ,kadawatha_loading.date1, kadawatha_loading.product, kadawatha_loading.units, kadawatha_unloading.ulunits, kadawatha_cdamages.dunits  from kadawatha_loading  LEFT JOIN kadawatha_unloading on kadawatha_loading.date1 = kadawatha_unloading.date1 AND kadawatha_loading.product = kadawatha_unloading.product LEFT JOIN kadawatha_cdamages on kadawatha_unloading.date1=kadawatha_cdamages.date1 AND kadawatha_unloading.product=kadawatha_cdamages.product where kadawatha_loading.date1=cast(now() as date)";
...
<html lang="en">
  <head>
    ...
    <title>Somawansa Stores - Kadawatha(RD) Sales Report</title>
...
<div class="x_panel">
                  <div class="x_title">
                    <h1 style="color: blue;">Kadawatha(RD) Sales Report</h1><small>Online Somawansa Stores Warehouse Management System</small>
