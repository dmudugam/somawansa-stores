...
$sql = "INSERT INTO kadawatha_ldamages(date1,product,dunits,value) VALUES ('$date','$type','$cases', '$value')";
...
<html lang="en">
  <head>
    ...
    <title>Kadawatha(RD) - Lorry Damages</title>
...
<div class="x_panel">
                  <div class="x_title">
                    <h1 style="color: red;">Kadawatha(RD) - Lorry Damages </h1><small> Online Somawansa Stores Warehouse Management System</small></h1>
