...
$sql = "INSERT INTO kicustomer(date1,product,dunits,value) VALUES ('$date','$type','$cases', '$value')";
...
<html lang="en">
  <head>
    ...
    <title>Kadawatha(INT) - Customer Damages</title>
...
<div class="x_panel">
                  <div class="x_title">
                    <h1 style="color: red;">Kadawatha(Interim) - Customer Damages </h1><small> Online Somawansa Stores Warehouse Management System</small></h1>
