...
$sql = "INSERT INTO kiloading(date1,product,units,value) VALUES ('$date','$type','$cases', '$value')";
...
<div class="x_panel">
                  <div class="x_title">
                    <h1 style="color: red;">Kadawatha(Interim) - Loading 1 </h1><small> Online Somawansa Stores Warehouse Management System</small></h1>
