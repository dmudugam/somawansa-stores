...
$sql = "UPDATE kiloading SET units=units+'$cases',value=value+'$value' WHERE date1='$date' AND product='$type'";
...
$dbh2 = mysqli_connect("localhost","somawans_Dineth1","DINETH123","somawans_warehouse");
mysqli_select_db($dbh2,'somawans_warehouse');
mysqli_query($dbh2,"UPDATE kadawatha SET date1='$date',units=units-'$cases',value=value-'$value' WHERE product='$type'");
}
?>
...
<html lang="en">
  <head>
    ...
    <title>Kadawatha(Interim) - Loading</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="profile.php" class="site_title"><i class="fa fa-paw"></i> <span>Kadawatha(Int)</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
             ...
             <li><a href ="home.php"><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                ...
                <li><a href ="kiloading.php"><i class="fa fa-edit"></i> Loading - 1<span class="fa fa-chevron-down"></span></a>
                  </li>
                  <li><a href ="kiloading2.php"><i class="fa fa-edit"></i> Loading - 2 <span class="fa fa-chevron-down"></span></a>
                  </li>

                  <li><a href ="kiunloading.php"><i class="fa fa-desktop"></i>Unloading<span class="fa fa-chevron-down"></span></a>
                  </li>
                  <li><a href ="kilorry.php"><i class="fa fa-desktop"></i>Lorry Damages<span class="fa fa-chevron-down"></span></a>
                  </li>
                  <li><a href ="kicustomer.php"><i class="fa fa-desktop"></i>Customer Damages<span class="fa fa-chevron-down"></span></a>
                  </li>
...
<div class="x_panel">
                  <div class="x_title">
                    <h1 style="color: red;">Kadawatha(Interim) - Loading 2</h1><small> Online Somawansa Stores Warehouse Management System</small></h1>
                    ...
                    while($output = mysqli_fetch_assoc ($done)) { ?>
                      ...
                      <?php }  ?>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="cases"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
