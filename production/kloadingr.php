...
$sql = "SELECT * from kadawatha_loading where date1 = cast(now() as date)";
...
<html lang="en">
  <head>
    ...
    <title>Somawansa Stores - Kadawatha(RD) Loading Report</title>
...
<div class="x_panel">
                  <div class="x_title">
                    <h1 style="color: blue;">Kadawatha(RD) - Loading Report </h1> <small>Online Somawansa Stores Warehouse Management System</small>
                      ...
                      <table   id="datatable-buttons" class="table table-striped table-bordered">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title" rowspan="2">Loading ID</th>  
                             <th class="column-title" rowspan="2">Date</th>
                            <th class="column-title" rowspan="2" >Product</th>
                            
                            <th class="column-title" colspan="2">Loading</th>
                            <th class="column-title" rowspan="2">Value</th>
                            <th class="column-title" rowspan="2">Unloading</th>
                            <tr>
