...
<html lang="en">
  <head>
    ...
    <title>Somawansa Stores - Kadawatha Warehouse Stock Report</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="profile.php" class="site_title"><i class="fa fa-paw"></i> <span>Kadawatha</span></a>
            </div>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                   <li><a href ="home.php"><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                      ...
                      <li><a href ="kware.php"><i class="fa fa-clone"></i>Kadawatha Warehouse Stock<span class="fa fa-chevron-down"></span></a>
                      </li>
                      <li><a href ="gware.php"><i class="fa fa-clone"></i>Ganemulla Warehouse Stock<span class="fa fa-chevron-down"></span></a>
                      </li>
                      <li><a href ="hware.php"><i class="fa fa-clone"></i>Horeca Warehouse Stock<span class="fa fa-chevron-down"></span></a>
                      </li>
...
<div class="x_panel">
                  <div class="x_title">
                    <h1 style="color: blue;">Kadawatha - Warehouse Stock Report </h1> <small>Online Somawansa Stores Warehouse Management System</small>
...
elseif ($row["product"]==="Raththi 400g") 
{
  $units = $row["units"]%36;
  $cases = ($row["units"]-$units)/36;
  $value = $row["units"]*307.65;
}
elseif ($row["product"]==="Raththi 1kg") 
{
  $units = $row["units"]%12;
  $cases = ($row["units"]-$units)/12;
  $value = $row["units"]*767.16;
}
...
elseif ($row["product"]==="Drinking Yogurt Vanilla") 
{
  $units = $row["units"]%24;
  $cases = ($row["units"]-$units)/24;
  $value = $row["units"]*61.60;
}
elseif ($row["product"]==="Drinking Yogurt Mango") 
{
  $units = $row["units"]%24;
  $cases = ($row["units"]-$units)/24;
  $value = $row["units"]*66.00;
}
?>
                <tr>
