...
$sql = "UPDATE ganemulla SET date1='$date',units = units+'$cases',value = value+'$value' WHERE product='$type' ";
...
<html lang="en">
  <head>
    ...
    <title>Warehouse - Ganemulla</title>
...
<div class="x_panel">
                  <div class="x_title">
                    <h1 style="color: red;">Ganemulla - Warehouse Loading </h1><small> Online Somawansa Stores Warehouse Management System</small></h1>
