...
$sql = "UPDATE horeca SET date1='$date',units = units+'$cases',value = value+'$value' WHERE product='$type' ";
...
<div class="x_panel">
                  <div class="x_title">
                    <h1 style="color: red;">Horeca - Warehouse Loading </h1><small> Online Somawansa Stores Warehouse Management System</small></h1>
